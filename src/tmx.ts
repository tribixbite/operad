...
/**
 * Resolve the runtime wrapper path for spawning child processes.
 * Delegates to platform abstraction to handle Termux bun wrapper vs desktop paths.
 */
...
function getClient(configPath?: string): IpcClient {
  try {
    ...
    // Fallback: use platform default socket path
